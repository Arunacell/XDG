...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[41;97;1m                  ARUNA TUNNELING                 \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Arunacell/permission/_/ipme | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Arunacell/permission/_/ipme | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Arunacell/permission/_/ipme | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Arunacell/XDG/_/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Arunacell/permission/_/ipme | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Arunacell/permission/_/ipme | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/Arunacell"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6281289275316"}]]}'
...
wget raw.githubusercontent.com/Arunacell/XDG/_/___files___/limit.sh && chmod +x limit.sh && ./limit.sh
...
git clone  https://github.com/Arunacell/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
